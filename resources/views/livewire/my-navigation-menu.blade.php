<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="flex">
            <button wire:click="spain">
                @if(session('lang')=='es')
                    <div class="bg-indigo-500 ml-2 px-1 py-1 text-white text-sm rounded-md font-bold">{{ __('Spanishs') }}</div>
                @else
                    <div class="font-thin text-gray-500 ml-2 px-1 py-1 text-sm">{{ __('Spanishss') }}</div>
                @endif
            </button>
            <button wire:click="italy">
                @if(session('lang')=='it')
                    <div class="bg-indigo-500 ml-2 px-1 py-1 text-white text-sm rounded-md font-bold">{{ __('Italian') }}</div>
                @else
                    <div class="font-thin text-gray-500 ml-2 px-1 py-1 text-sm">{{ __('Italian') }}</div>
                @endif
            </button>
            <button wire:click="engla">
                @if(session('lang')=='en')
                    <div class="bg-indigo-500 ml-2 px-1 py-1 text-white text-sm rounded-md font-bold">{{ __('English') }}</div>
                @else
                    <div class="font-thin text-gray-500 ml-2 px-1 py-1 text-sm">{{ __('English') }}</div>
                @endif
            </button>
        </div>
